...
// WIFI params
char* WIFI_SSID = "MBB";    // Configure here the SSID of your WiFi Network
char* WIFI_PSWD = "0305laura@"; // Configure here the PassWord of your WiFi Network
int WIFI_DELAY  = 100; //ms

// oneM2M : CSE params
String CSE_IP      = "192.168.43.154"; //Configure here the IP Address of your oneM2M CSE
